package coffeecatteam.genOrator.objects.blocks;

import coffeecatteam.genOrator.Tabs;
import coffeecatteam.genOrator.objects.blocks.base.BlockBase;
import coffeecatteam.genOrator.objects.tileentity.TileCable;
import coffeecatteam.genOrator.util.aabb.Bounds;
...
public class BlockCable extends BlockBase implements ITileEntityProvider {
    ...
    public BlockCable(String name) {
        super(name, 0.1F, 1.0F, Material.ROCK, Tabs.BLOCKS);
